...
public class PersonalizacionCompletaRobotActivity extends TopBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modulo_personalizacion_completo_robot);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<>(PersonalizacionCompletaRobotActivity.this, android.R.layout.simple_spinner_dropdown_item, items);
        ...
        ArrayAdapter<String> adapterGeneroRobot = new ArrayAdapter<>(PersonalizacionCompletaRobotActivity.this, android.R.layout.simple_spinner_dropdown_item, itemsGeneroRobot);
        ...
        ArrayAdapter<String> adapterGrupoEdadRobot = new ArrayAdapter<>(PersonalizacionCompletaRobotActivity.this, android.R.layout.simple_spinner_dropdown_item, itemsGrupoEdadRobot);
        ...
        botonAceptar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent moduloConversacionalActivity = new Intent(PersonalizacionCompletaRobotActivity.this, MenuConfiguracionActivity.class);
        ...
        botonAtras.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Intent cuestionarioEdadActivity = new Intent(PersonalizacionCompletaRobotActivity.this, MenuConfiguracionActivity.class);
