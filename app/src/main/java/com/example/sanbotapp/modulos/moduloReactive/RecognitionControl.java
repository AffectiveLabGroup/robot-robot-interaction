...
public class RecognitionControl implements TextureView.SurfaceTextureListener{
    ...
    public String responseModelExpression = "";
    ...
    public void startRecognition(String task, String method){
        ...
        saveScreenshot(context, screenshot);
    ...
    public void sendImageToServerModels(String base64Image, String task, String method) {
        try {
            ...
            if (code == HttpURLConnection.HTTP_OK) {
                ...
                ResponseModelProcesing(response.toString());
    ...
    public void ResponseModelProcesing(String respuesta) {
            if (respuesta.contains("happy") || respuesta.contains("happiness")) {
                responseModelExpression = "happy";
            } else if (respuesta.contains("sad") || respuesta.contains("sadness")) {
                responseModelExpression = "sad";
            } else if (respuesta.contains("angry") || respuesta.contains("anger")) {
                responseModelExpression = "angry";
            } else if (respuesta.contains("fear")) {
                responseModelExpression = "fear";
            } else if (respuesta.contains("disgust")) {
                responseModelExpression = "disgust";
            } else if (respuesta.contains("surprise")) {
                responseModelExpression = "surprise";
            } else {
                responseModelExpression = "Emocion no detectada";
            }
    }
    ...
    public void saveScreenshot(Context context, Bitmap bitmap) {
        ...
        try {
            ...
            System.out.println( "Imagen guardada en galeria " );
        } catch (IOException e) {
            e.printStackTrace();
